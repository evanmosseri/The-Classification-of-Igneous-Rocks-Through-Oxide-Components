...
# classifiers_path = "./new/"
# classifier_name = "DecisionTreeClassifier.pkl"
...
print ".pkl" in args.classifier
if ".pkl" in args.classifier:
	if os.path.isfile(classifiers_path+args.classifier):
		classifier_name = classifiers_path+args.classifier
